...
public class SignInActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Assign Button FB
        myLoginFBBUtton=(LoginButton) findViewById(R.id.login_button);
        // Set click listeners
        ...
        myLoginFBBUtton.registerCallback(myCallBackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                Log.d(TAG, "facebook:onSuccess: 111111111111111111111111111111111111111111111111111" + loginResult);
                handleFacebookAccessToken(loginResult.getAccessToken());
            }

            @Override
            public void onCancel() {
                Log.d(TAG, "facebook:onCancel 22222222222222222222222222222222222222222");
                // [START_EXCLUDE]
                //updateUI(null);
                // [END_EXCLUDE]
            }
            ...
            public void onError(FacebookException e) {
                Log.d(TAG, "facebook:onError 333333333333333333333333333333333333333", e);
                // [START_EXCLUDE]
                //updateUI(null);
                // [END_EXCLUDE]
            }
